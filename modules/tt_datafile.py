...
from modules.tt_tag import TagID
from modules.tt_time import BTime
import modules.tt_util as ut
from modules.day_data import TrackerDay
...
def read_tagtracker_datafile(
    filename: str, err_msgs: list[str], usable_tags: list[str] = None
) -> TrackerDay:
    ...
    with open(filename, "r", encoding="utf-8") as f:
        for line_num, line in enumerate(f, start=1):
            ...
            # FIXME: this has to keep track of tags enough to tell when a
            # FIXME: tag's visit has closed. Probably:
            # FIXME:    - collect all the tags in & outs, then match them
            # FIXME:      into pairs.  This future-proofs for tag re-use.
